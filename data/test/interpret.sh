...
#do this in own test.sh instead
#echo "test?"
#PY_SCRIPT=../../scripts/test.py
#${PY_SCRIPT} -o ${OUT_DIR} ${OUT_DIR}/model_epoch_best_4.pth \
...
# output: (folder “./ExplaiNN/AI-TAC/”) filters.meme, importances.tsv, etc.
...
# output: ./ExplaiNN/AI-TAC/clusters/”) clusters.meme, clusters.tsv.gz, etc.
...
# output: (folder “./ExplaiNN/CTCF/logos/”) filter0.fwd.png, filter0.rev.png, etc.
...
# output: ./ExplaiNN/AI-TAC/tomtom/tomtom.tsv.gz
