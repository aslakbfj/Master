...
awk -v OFS="\t" '{for(i=1; i<=NF; i++) if($i > 4) $i=1; else $i=0} 1' ./AI-TAC/AI-TAC_heights.txt > ./AI-TAC/AI-TAC_binary_heights.txt
...
${PY_SCRIPT} -o ${OUT_DIR} --input-length 251 --criterion bcewithlogits \
